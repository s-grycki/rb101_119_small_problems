...
Return a hash which shows the number of words at different sizes. Words are a string
of alphabetic characters that do not include a space
...
- Words can only contain alphabetics
...
LOOP over each element in words array
  DELETE each non-instance of alphabetic character in word
